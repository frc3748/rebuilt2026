...
public class DumperIOSpark implements DumperIO {
    ...
    public DumperIOSpark() {
        ...
        dumperConfig
                .inverted(DumperConstants.kDumperInverted)
        ...
        dumperConfig.closedLoop
                ...
                .pid(DumperConstants.kDumperP, DumperConstants.kDumperI, DumperConstants.kDumperD).maxMotion
                .maxAcceleration(DumperConstants.kDumperMaxAccel)
        ...
        dumperConfig
            .softLimit
            .forwardSoftLimit(DumperConstants.kForwardSoftLimit)
            .forwardSoftLimitEnabled(true)
            .reverseSoftLimit(DumperConstants.kBackwardSoftLimit)
        ...
        SparkUtil.tunePID(
                ...
                dumper,
                dumperConfig,
                new double[] { DumperConstants.kDumperP, DumperConstants.kDumperI, DumperConstants.kDumperD,
                        DumperConstants.kDumperS, DumperConstants.kDumperV, DumperConstants.kDumperA,
                        DumperConstants.kDumperG, DumperConstants.kDumperMaxAccel, DumperConstants.kDumperCruiseVel,
                        DumperConstants.kDumperDeviationErr },
        ...
        SmartDashboard.putData("Dumper/Zero", new InstantCommand(() -> {
            dumperEncoder.setPosition(0);
        }));

        SmartDashboard.putData("Dumper/Disable", new InstantCommand(() -> {
            dumperDisabled = true;
        }));
        SmartDashboard.putData("Dumper/Enable", new InstantCommand(() -> {
            dumperDisabled = false;
    ...
    public void updateInputs(DumperIOInputs inputs) {
        inputs.dumperPos = dumperEncoder.getPosition();        
        inputs.dumperVelRadPerSec = dumperEncoder.getVelocity();
        ifOk(dumper, new DoubleSupplier[] { dumper::getAppliedOutput, dumper::getBusVoltage },
                (values) -> inputs.appliedVolts = values[0] * values[1]);
        ifOk(dumper, dumper::getOutputCurrent, (value) -> inputs.currentAmps = value);
    ...
    public void setDumperPosition(double position) {
        ...
        position = MathUtil.inputModulus(position, DumperConstants.kBackwardSoftLimit, DumperConstants.kForwardSoftLimit);
        this.desiredPos = position;
